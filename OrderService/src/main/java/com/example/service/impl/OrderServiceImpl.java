...
import com.example.service.client.InventoryService;
import com.example.service.client.PaymentService;
import com.example.service.client.UserService;
...
public class OrderServiceImpl implements OrderService {
	...
	public OrderResponse placeOrder(OrderRequest orderRequest) throws OrderNotFoundException {
		// Check user found or not with user_id
		userService.getSingleUser(orderRequest.getUserId());
		
		// Check product's quantity is available or not(in inventory_details table).
		inventoryService.updateInventoryQuantity(orderRequest.getProductId(), orderRequest.getQuantity());
